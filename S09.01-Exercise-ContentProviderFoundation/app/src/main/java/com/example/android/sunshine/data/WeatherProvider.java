...
public class WeatherProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        retVal.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER,CODE_WEATHER);
        retVal.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER + "/#",CODE_WEATHER_WITH_DATE);
        return retVal;
    }
    @Override
        ...
        Cursor cursor = null;
            switch (uriMatcher.match(uri)){
                ...
                case CODE_WEATHER_WITH_DATE:
                    ...
                    break;
                default:
                    Log.e("WeatherProvider","The specified uri was unknown: " + uri.toString());
                    break;
            }
