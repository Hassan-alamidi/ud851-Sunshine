...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    interface TaskLoaderInterface{
        void setVisability(View v);
    }

    private static class taskLoader extends AsyncTaskLoader<String[]>{
        String[] weatherData = null;
        TaskLoaderInterface inter;
        Context context;
        String param = null;
        private taskLoader(Context c, String p, TaskLoaderInterface communications){
            super(c);
            context = c;
    ...
    public Loader<String[]> onCreateLoader(int id, Bundle args) {
        ...
        TaskLoaderInterface communications = new TaskLoaderInterface() {
            @Override
            public void setVisability(View v) {
                mLoadingIndicator.setVisibility(v.getVisibility());
            }

        };
        return new taskLoader(this,location,communications);
