...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String userPreference = sharedPreferences.getString(key,defaultLoc);
    ...
    public static boolean isMetric(Context context) {
        ...
        String userPreference = sharedPreferences.getString(key,metric);
        if(metric.equals(userPreference)) {
            return true;
        }
        return false;
    }
